...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200/90 bg-white/70 px-6 py-16 text-center shadow-elevate backdrop-blur-[2px]">
      <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-ocean-100/80 bg-gradient-to-br from-ocean-50 to-teal-50/80 text-2xl shadow-inner-soft">
        ✦
      </div>
